...
class Rti(Jmp):
    ...
    @classmethod
    def write(cls, cpu, memory_address, value):
        # get the stored status from the stack, and then set that status reg
